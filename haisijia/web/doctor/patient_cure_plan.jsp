							...
							<tbody>
								<tr>
									...
									<td style="text-align: center;">
										<a href="main?cmd=showDoctorAdviceTemplateDetailNew&stmId=22&ssmId=24">老年男性患者</a>
...
function enrollPatient() {
	window.location.href = "main?cmd=showPatientChooseDoctorAdviceTemplate&stmId=22&ssmId=24";
}
</script>
