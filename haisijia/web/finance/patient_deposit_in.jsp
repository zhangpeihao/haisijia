								...
								<div class="box border blue">
									...
									<div class="box-body">
										<div class="alert alert-success">
											...
											<h4>押金信息</h4>
											<p>
												总额：<input type="text" value="10000" />&nbsp;&nbsp;
												余额：<input type="text" value="100" />&nbsp;&nbsp;
												费用额：<input type="text" value="900" />&nbsp;&nbsp;
											</p>
										</div>
										 <form class="form-horizontal " action="#">
											<div class="form-group">
												...
												<div class="col-md-4">
													<select id="b1" class="form-control">
														<option value="1">交款</option>
														<option value="2">退款</option>
													</select>
												</div>
												<label class="col-md-2 control-label">退款密码</label>
												<div class="col-md-4">
													<input class="form-control" type="password" name="residentHospitalCode" size="10" id="residentHospitalCode">
												</div>
											</div>	
											<div class="form-group">
												<label class="col-md-2 control-label">交款人*</label>
												<div class="col-md-4">
													<input class="form-control" type="text" name="residentHospitalCode" size="10" id="residentHospitalCode">
												</div>
												<label class="col-md-2 control-label">与患者关系*</label>
												<div class="col-md-4">
											...
											<div class="form-group">
												<label class="col-md-2 control-label">交款金额</label>
												<div class="col-md-4">
													<input class="form-control" type="text" name="residentHospitalCode" size="10" id="residentHospitalCode">
												</div>
											...
											<div class="form-group">
												<label class="col-md-2 control-label">支票</label>
												<div class="col-md-4">
													<input class="form-control" type="text" name="residentHospitalCode" size="10" id="residentHospitalCode">
												</div>
