							...
							<tr style="border: 0px blue solid;">
								...
								<td style="border: 1px blue solid;">
									<table style="width: 100%; color: white;">
										<tr style="background-color: red;"><td id="td1">透析</td></tr>
								...
								<td style="border: 1px blue solid;">
									<table style="width: 100%; color: white;">
										<tr style="background-color: red;"><td>***</i></td></tr>
										<tr style="background-color: green;"><td>***</td></tr>
										<tr style="background-color: blue;"><td>&nbsp;</td></tr>
									</table>
								</td>
								<td style="border: 1px blue solid;">
									<table style="width: 100%; color: white;">
										...
										<tr style="background-color: green;"><td>透析</td></tr>
										<tr style="background-color: blue;"><td>***</td></tr>
									</table>
								</td>
								<td style="border: 1px blue solid;">
								...
								<td style="border: 1px blue solid;">
									<table style="width: 100%; color: white;">
										<tr style="background-color: red;"><td>透析</td></tr>
										<tr style="background-color: green;"><td>***</td></tr>
										<tr style="background-color: blue;"><td>&nbsp;</td></tr>
									</table>
								</td>
...
function choosePatient() {
	window.location.href = "main?cmd=showSchedulePatientChoosePatient&stmId=15&ssmId=20";
}
</script>
