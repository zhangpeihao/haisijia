					...
					<div class="box-body">
						 <form class="form-horizontal " action="#">
							<div class="form-group">
								...
								<label class="col-md-2 control-label">透析材料</label>
								<div class="col-md-4">
									<select id="materialId" class="form-control">
										<option value="0">全部</option>
										<option value="1">IL001</option>
										<option value="2">IL002</option>
									</select>
								</div>
							</div>	
							<div class="form-group">
								...
								<label class="col-md-2 control-label">&nbsp;</label>
								<div class="col-md-4">
									<button type="button" class="btn btn-primary" style="float: right;">查询</button>
								</div>
							</div>																																
						</form>
					</div>
					...
					<div class="box-body">
						<table class="table table-bordered table-striped">
							...
							<tbody>
								<tr>
									<td>1</td>
									<td><input type="radio" class="uniform" value="" checked="true"></td>
