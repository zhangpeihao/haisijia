								...
								<div class="box border blue">
									<div class="box-title">
										<h4><i class="fa fa-table"></i>
                                            <a href="" style="color: white;">患者出院</a>»
                                            <a href="" style="color: white;">出院办理</a>
                                        </h4>
									</div>
									<div class="box-body">
										<div class="alert alert-success">
										 ...
										 <form class="form-horizontal " action="#">
											<div class="form-group">
												...
												<label class="col-md-2 control-label">出院类型</label>
												<div class="col-md-4">
													<select class="form-control" size="1">
														<option value="1">转院</option>
														<option value="1">死亡</option>
													</select>
												</div>
											</div>	
											<div class="form-group">
												<label class="col-md-2 control-label">出院备注</label>
												<div class="col-md-10">
...
function addPatient() {
	alert("患者出院办理成功！");
	window.location.href = "main?cmd=showPatientQuit&stmId=32&ssmId=34";
}
