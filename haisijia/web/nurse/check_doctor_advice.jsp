									...
									<div class="box-body big">
										<div class="alert alert-success">
											...
											<select size="1">
												...
												<option value="1" selected><span style="background-color: red; color: white;">&nbsp;&nbsp;&nbsp;护士审核&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;</option>
												<option value="2"><span style="background-color: green; color: white;">&nbsp;&nbsp;&nbsp;护士拒绝&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;</option>
												<option value="3"><span style="background-color: blue; color: white;">&nbsp;&nbsp;&nbsp;库房审核&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;</option>
												<option value="3"><span style="background-color: blue; color: white;">&nbsp;&nbsp;&nbsp;库房拒绝&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;</option>
												<option value="3"><span style="background-color: blue; color: white;">&nbsp;&nbsp;&nbsp;财务审核&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;</option>
												<option value="3"><span style="background-color: blue; color: white;">&nbsp;&nbsp;&nbsp;财务拒绝&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;</option>
												<option value="3"><span style="background-color: blue; color: white;">&nbsp;&nbsp;&nbsp;完成&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;</option>
											</select>
											<button id="insertAfter" type="button" class="btn btn-primary">通过</button>&nbsp;											
											<button id="insertAfter" type="button" class="btn btn-primary">拒绝</button>&nbsp;
											<input type="text" style="width: 600px;" placeholder="填写拒绝拒原因" />
										</div>
										<div class="row">										
											<div class="col-md-2">
														   ...
														   <div class="tab-pane fade in active" style="overflow: auto;" id="tab_1_1">
															  <div class="divide-10" style="text-align: right;"></div>
																...
																<table id="daItemsTable" class="table table-bordered table-striped" style="table-layout:fixed; word-break: break-all; word-wrap: break-word;font-size: 5px; width: 2000px;">
																	...
																	<tbody>
																		<tr>
																			<td class="da_col_1">1</th>
																			<td class="da_col_2">临</th>
																			<td class="da_col_3">药品</th>
																			<th class="da_col_4">2016-04-13 13:30</th>
																			<th class="da_col_5">低分子肝素</th>
																			<th class="da_col_6">正常</th>
																			<th class="da_col_7">300</th>
																			<th class="da_col_8">ml</th>
																			<th class="da_col_9">静脉注射</th>
																			<th class="da_col_10">1/日</th>
																			<th class="da_col_11">2016-04-13 14:30</th>
																			<th class="da_col_12">N/A</th>
																			<th class="da_col_13">2016-04-13 12:59</th>
																			<th class="da_col_14">抗凝方案</th>
																			<th class="da_col_15">张三</th>
																			<th class="da_col_16">1</th>
																			<th class="da_col_17">无</th>
																			<th class="da_col_18">无</th>
																			<th class="da_col_19">删除</th>
																		</tr>
																		<tr>
																			<td class="da_col_1">2</th>
																			<td class="da_col_2">临</th>
																			<td class="da_col_3">药品</th>
																			<th class="da_col_4">2016-04-13 13:30</th>
																			<th class="da_col_5">盐酸二甲双胍肠溶片</th>
																			<th class="da_col_6">正常</th>
																			<th class="da_col_7">3</th>
																			<th class="da_col_8">片</th>
																			<th class="da_col_9">口服</th>
																			<th class="da_col_10">3/日</th>
																			<th class="da_col_11">2016-04-13 14:30</th>
																			<th class="da_col_12">N/A</th>
																			<th class="da_col_13">2016-04-13 12:59</th>
																			<th class="da_col_14">降血糖药物</th>
																			<th class="da_col_15">张三</th>
																			<th class="da_col_16">1</th>
																			<th class="da_col_17">无</th>
																			<th class="da_col_18">无</th>
																		...
																		<tr>
																			<td class="da_col_1">3</th>
																			<td class="da_col_2">临</th>
																			<td class="da_col_3">耗材</th>
																			<th class="da_col_4">2016-04-13 13:30</th>
																			<th class="da_col_5">穿刺针</th>
																			<th class="da_col_6">正常</th>
																			<th class="da_col_7">1</th>
																			<th class="da_col_8">个</th>
																			<th class="da_col_9">&nbsp;</th>
																			<th class="da_col_10">&nbsp;</th>
																			<th class="da_col_11">2016-04-13 14:30</th>
																			<th class="da_col_12">N/A</th>
																			<th class="da_col_13">2016-04-13 12:59</th>
																			<th class="da_col_14">&nbsp;</th>
																			<th class="da_col_15">张三</th>
																			<th class="da_col_16">1</th>
																			<th class="da_col_17">无</th>
																			<th class="da_col_18">无</th>
																		...
																		<tr>
																			<td class="da_col_1">4</th>
																			<td class="da_col_2">临</th>
																			<td class="da_col_3">治疗</th>
																			<th class="da_col_4">2016-04-13 13:30</th>
																			<th class="da_col_5">血液透析治疗</th>
																			<th class="da_col_6">正常</th>
																			<th class="da_col_7">1</th>
																			<th class="da_col_8">次</th>
																			<th class="da_col_9">&nbsp;</th>
																			<th class="da_col_10">&nbsp;</th>
																			<th class="da_col_11">2016-04-13 14:30</th>
																			<th class="da_col_12">N/A</th>
																		...
																		<tr>
																			<td class="da_col_1">5</th>
																			<td class="da_col_2">临</th>
																			<td class="da_col_3">检查</th>
																			<th class="da_col_4">2016-04-13 13:30</th>
																			<th class="da_col_5">血常规检查</th>
																			<th class="da_col_6">正常</th>
																			<th class="da_col_7">1</th>
																			<th class="da_col_8">次</th>
																			<th class="da_col_9">&nbsp;</th>
																		...
																		<tr>
																			<td class="da_col_1">6</th>
																			<td class="da_col_2">临</th>
																			<td class="da_col_3">检查</th>
																			<th class="da_col_4">2016-04-13 13:30</th>
																			<th class="da_col_5">尿常规检查</th>
																			<th class="da_col_6">正常</th>
																			<th class="da_col_7">1</th>
																			<th class="da_col_8">次</th>
																			<th class="da_col_9">&nbsp;</th>
															...
															<div class="tab-pane fade" id="tab_1_2">
																...
																<form class="form-horizontal " action="#">
																	<div class="form-group">
																		...
																		<div class="col-md-4">
																			<input class="form-control" type="text" name="residentHospitalCode" size="10" id="residentHospitalCode" value="H001" readonly />
																		</div>
																		<label class="col-md-2 control-label">姓名*</label>
																		<div class="col-md-4">
																			<input class="form-control" type="text" name="residentHospitalCode" size="10" id="residentHospitalCode" value="张九长" readonly />
																		</div>
																	</div>		
																	<div class="form-group">
																		<label class="col-md-2 control-label">透析日期*</label>
																		<div class="col-md-4">
																			<input  class="form-control" type="text" name="txDate" id="txDate" size="10" value="2016-04-13" readonly />
																		</div>
																		<label class="col-md-2 control-label">透析总次数</label>
																		<div class="col-md-4">
																			<input class="form-control" type="text" name="residentHospitalCode" size="10" id="residentHospitalCode" value="2343" readonly />
																		</div>
																	</div>		
																	<div class="form-group">
																	...
																	<div class="form-group">
																		...
																		<div class="col-md-4">
																			<select id="cureMode" class="form-control" readonly>
																				<option value="1">HD</option>
																				<option value="1">HDF</option>
																				<option value="1" selected>HF</option>
																		...
																		<div class="col-md-4">
																			<input type="text" name="zhyl" size="10" id="zhyl" style="width: 90%;" value="100" readonly />升
																		</div>
																	</div>	
																	<div class="form-group">
																		<label class="col-md-2 control-label">透析（滤）器</label>
																		<div class="col-md-4">
																			<select id="txlq" class="form-control" readonly>
																				<option value="1">14L</option>
																				<option value="1">FX60</option>
																				<option value="1" selected>HDF</option>
																		...
																		<label class="col-md-2 control-label">置换液量</label>
																		<div class="col-md-4">
																			<input type="text" name="zhyl" size="10" id="zhyl" style="width: 90%;" value="2" readonly />升
																		</div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">透析液成份-钠</label>
																		<div class="col-md-4">
																			<input type="text" name="zhyl" size="10" id="zhyl" style="width: 80%;" value="200" readonly />mmol/L
																		</div>
																		<label class="col-md-2 control-label">透析液成份-钙</label>
																		<div class="col-md-4">
																			<input type="text" name="zhyl" size="10" id="zhyl" style="width: 80%;" value="150" readonly />mmol/L
																		</div>
																	</div>
																	<div class="form-group">
																		...
																		<div class="col-md-4">
																			<input type="text" name="zhyl" size="10" id="zhyl" style="width: 80%;" value="20" readonly />ml/min
																		</div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">血管通路</label>
																		<div class="col-md-4">
																			<input type="radio" class="uniform" value="" checked readonly />自体AV内痿&nbsp;
																			<input type="radio" class="uniform" value="" readonly />临时管&nbsp;
																			<input type="radio" class="uniform" value="" readonly />半永久管&nbsp;
																			<input type="radio" class="uniform" value="" readonly />人造血管&nbsp;
																		</div>
																		<label class="col-md-2 control-label">治疗时间</label>
																		<div class="col-md-4">
																			<input type="text" name="zhyl" size="10" id="zhyl" style="width: 80%;" value="4" readonly />h
																		</div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">UFR URF1</label>
																		<div class="col-md-4">
																			<input type="text" name="zhyl" size="10" id="zhyl" style="width: 80%;" value="2" readonly />L/h
																		</div>
																	...
																	<div class="form-group">
																		...
																		<div class="col-md-4">
																			<select id="xzgs" class="form-control" readonly>
																				<option value="1">肝素</option>
																				<option value="1" selected>低分子肝素</option>
																		...
																		<div class="col-md-4">
																			<input type="text" name="zhyl" size="10" id="zhyl" style="width: 80%;" value="100" readonly />IU
																		</div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">维持</label>
																		<div class="col-md-4">
																			<input type="text" name="zhyl" size="10" id="zhyl" style="width: 80%;" value="10" readonly />IU
																		</div>
																		<label class="col-md-2 control-label">追加</label>
																		<div class="col-md-4">
																			<input type="text" name="zhyl" size="10" id="zhyl" style="width: 80%;" value="20" readonly />IU
																		</div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">总量</label>
																		<div class="col-md-4">
																			<input type="text" name="zhyl" size="10" id="zhyl" style="width: 80%;" value="1000" readonly />IU
																		</div>
