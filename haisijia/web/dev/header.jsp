	...
	<header class="navbar clearfix" id="header">
		<div class="container">
				...
				<ul class="nav navbar-nav pull-left hidden-xs" id="navbar-left">					
					<li class="dropdown" style="background-color: #8fb4d8;">
						<a id="mainMenu1" href="main?cmd=showDevPageList" 
                                                class="team-status-toggle dropdown-toggle tip-bottom" data-toggle="tooltip" title="页面列表">
							<i class="fa fa-users"></i>
							<span id="forum" class="name">页面维护</span>
				...
				<ul class="nav navbar-nav pull-right">
                    ...
                    function logoutUser() {
                        var reqUrl = "index.php?f=c_user&c=CUser&m=logoutUserAjax";
                        $.ajax({
                            url: reqUrl,
                            type: "GET",
