								...
								<div class="box border blue">
									<div class="box-title">
										<h4><i class="fa fa-table"></i>
                                            ...
                                            <a href="" style="color: white;">随访计划更新</a>
                                        </h4>
									</div>
									<div class="box-body">
										 <form class="form-horizontal " action="#">
											<div class="form-group">
												...
												<div class="col-md-4">
													<input  class="form-control datepicker" type="text" name="startDate" id="startDate" size="10" value="2016-05-03" />
												</div>
												<label class="col-md-2 control-label">结束日期*</label>
												<div class="col-md-4">
													<input  class="form-control datepicker" type="text" name="endDate" id="endDate" size="10" value="2016-06-30">
												</div>
											</div>	
											<div class="form-group">
												<label class="col-md-2 control-label">名称*</label>
												<div class="col-md-4">
													<input class="form-control" type="text" name="residentHospitalCode" size="10" id="residentHospitalCode" value="端午优惠透析计划" />
												</div>
												<label class="col-md-2 control-label">患者列表</label>
												<div class="col-md-4">
													共30名患者<button id="choosePatientsBtn" type="button" class="btn btn-primary">添加</button>
												</div>
											</div>											
											<div class="form-group">
												<label class="col-md-2 control-label">计划描述</label>
												<div class="col-md-10">
													<textarea class="form-control" rows="5">在本期活动中，我们特邀中华医学会肾科主任陈教授，做慢性肾病透析患者怎样高效进行透析管理。本次随访目的是通过电话邀请随访患者到血液透析中心来听讲座，会后赠送小礼品和宣传资料，争取获得5名新患者。</textarea>
												</div>
											</div>	
											<div class="form-group">
