									...
									<div class="box-body">
										 <form class="form-horizontal " action="#">
											<div class="form-group">
												...
												<div class="col-md-4">
													<input  class="form-control datepicker" type="text" name="startDate" id="startDate" size="10" value="2016-03-25" />
												</div>
												<label class="col-md-2 control-label">随访人员*</label>
												<div class="col-md-4">
													<select id="followupUserId" class="form-control">
														<option value="1">未知</option>
														<option value="2" selected>张天天</option>
													</select>
												</div>
											</div>	
											<div class="form-group">
												...
												<div class="col-md-4">
													<select id="followupResultId" class="form-control">
														...
														<option value="3" selected>感兴趣</option>
											...
											<div class="form-group">
												...
												<div class="col-md-10">
													<textarea class="form-control" rows="5">总体而言客户比较感兴趣，但是希望得到更大的优惠（与县医院相比）。</textarea>
												</div>
											</div>	
											<div class="form-group">
												<label class="col-md-2 control-label">&nbsp;</label>
