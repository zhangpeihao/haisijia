				...
				<div class="box border blue">
					<div class="box-title">
						<h4>
							...
							<a href="main?cmd=showFollowupPlans&stmId=12&ssmId=13&stmId=12&ssmId=13" style="color: white;">随访记录</a> >>
							患者列表
						</h4>
						<div class="tools">
					...
					<div class="box-body">
						<table class="table table-bordered table-striped">
							...
							<tbody>
								<tr>
									<td>1</td>
									<td><a href="main?cmd=showPatientFollowupRecords&stmId=12&ssmId=14">赵一</a></td>
									<td>男</td>
									<td>55</td>
									<td>小学</td>
									<td>司机</td>
